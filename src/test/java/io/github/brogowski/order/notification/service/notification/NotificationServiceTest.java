...
class NotificationServiceTest {
  ...
  void sendsMockEmailAndStoresNotificationLog() {
    ...
    InMemoryNotificationLogRepository notificationLogRepository =
        new InMemoryNotificationLogRepository();
    NotificationService service =
        new NotificationService(
            new DefaultEmailMessageFactory(),
            emailSender,
  ...
  void returnsNotificationLogByRequestId() {
    ...
    InMemoryNotificationLogRepository notificationLogRepository =
        new InMemoryNotificationLogRepository();
    notificationLogRepository.savedLog =
        new NotificationLog(
            requestId,
            "PL123456789",
            "recipient@example.com",
    ...
    Optional<NotificationLogDto> log = service.findByRequestId(requestId);
